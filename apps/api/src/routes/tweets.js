...
const {
  httpCreateNewTweet,
  httpGetAllTweets,
} = require('../components/tweets/tweets.controllers')

function getTweetsRoutes() {
   ...
   *
   */
  router.post('/', httpCreateNewTweet)

  return router
}

module.exports = { getTweetsRoutes }
